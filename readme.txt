...
That plugin will display an Instagram feed using the Instagram API.
...
If you have the zip file of this plugin, you need to go to WordPress admin area and visit Plugins » Add New page.
